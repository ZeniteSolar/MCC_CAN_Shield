...
void sweep(void)
{
    ...
    if(sweep_completed){
        ...
        VERBOSE_MSG_MACHINE(usart_send_string(",vi:"));
        VERBOSE_MSG_MACHINE(usart_send_float(control.mpp_vi));
        VERBOSE_MSG_MACHINE(usart_send_string(",ii:"));
        VERBOSE_MSG_MACHINE(usart_send_float(control.mpp_ii));
